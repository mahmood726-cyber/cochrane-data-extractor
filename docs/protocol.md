        # Cochrane Data Extractor: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/cochrane-data-extractor.git

        ## Objective

        Cochrane Data Extractor automates the extraction and structuring of data from Cochrane systematic reviews for downstream meta-analytic replication and auditing.
        ...
        - Code: https://github.com/mahmood726-cyber/cochrane-data-extractor.git
        - Dashboard: https://mahmood726-cyber.github.io/cochrane-data-extractor/
